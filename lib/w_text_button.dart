...
class _EstadoTextButton extends State<EstadoTextButton> {
  String contenido =
      "The following Yes/no are textButtons. they are alingned to bottom right of the content.";
  String contenido2 =
      "Las siguientes opciones no son TextButtons estos estan alineados abajo a la derecha del contenido";
  String contenido3 =
      "The following Yes/no are textButtons. they are alingned to bottom right of the content";
